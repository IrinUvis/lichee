...
class UpdateChannelService {
  ...
  Future<Channel> updateChannelById(String id, Channel updatedChannel) async {
    ...
    final sameChannelButNew = await _repository.updateById(id: id, updatedChannel: channel);
  ...
  Future<Channel> addUserToChannelById(String user, String channel) async {
    ...
    final sameChannelButWithMoreMembers = await _repository.updateById(id: channel, updatedChannel: gotChannel);
  ...
  Future<Channel> removeUserFromChannelById(String user, String channel) async {
    ...
    final sameChannelButWithLessMembers = await _repository.updateById(id: channel, updatedChannel: gotChannel);
